...
class AnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create answer" do
    assert_difference('Answer.count') do
      post answers_url, params: { answer: { description: @answer.description, name: @answer.name } }
    end
  ...
  test "should update answer" do
    patch answer_url(@answer), params: { answer: { description: @answer.description, name: @answer.name } }
